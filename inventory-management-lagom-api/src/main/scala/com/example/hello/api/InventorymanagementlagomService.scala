...
object InventorymanagementlagomService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The inventory-management-lagom service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the InventorymanagementlagomService.
  */
trait InventorymanagementlagomService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("inventory-management-lagom")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(InventorymanagementlagomService.TOPIC_NAME, greetingsTopic)
